...
* Compile Model
* Camera Model¿¡ µû¶ó¼­ ÄÄÆÄÀÏ µÇ´Â ÇÁ·ÎÅäÄÝÀÌ ´Þ¶óÁø´Ù.
* MODEL_HD_SUNNY_10X
* MODEL_HD_SUNNY_20X
* MODEL_HD_SUNNY_18X
*************************************************************************************************************/
#define PTC_MODEL				MODEL_HD_SUNNY_20X
...
typedef enum _IFER {
	IF_ERNO = 0x0,			// Á¤»ó
	IF_ERFPNULL = 0x1,		// ÇÔ¼ö Æ÷ÀÎÆ®°¡ ¾ø½¿
	IF_INVALIDVAL = 0x2,	// Ã³¸®ÇÒ ¼ö ¾ø´Â °ªÀÓ(App -> OSD, Protocol)
	IF_ERNOPROC = 0x4,		// Ã³¸®ÇÏÁö ¾ÊÀ½
} IFER;

typedef enum _IFER_VISCA {
	IF_COMPLETE = 0x0,		// Á¤»ó
	IF_SYNTEX	= 0x1,		// ÇÔ¼ö Æ÷ÀÎÆ®°¡ ¾ø½¿
	IF_LENGTH	= 0x2,		// Ã³¸®ÇÒ ¼ö ¾ø´Â °ªÀÓ(App -> OSD, Protocol)
	IF_NOEXCUTE = 0x4,		// Ã³¸®ÇÏÁö ¾ÊÀ½
	IF_PASS = 0x8,		// PASS, SocketÀ» ¹Ù²Þ
} _IFER_VISCA;

typedef enum _IFER_CNBH {
	IFH_COMPLETE = 0x0,		// Á¤»ó
	IFH_SYNTEX	= 0x1,		// ÇÔ¼ö Æ÷ÀÎÆ®°¡ ¾ø½¿
	IFH_LENGTH	= 0x2,		// Ã³¸®ÇÒ ¼ö ¾ø´Â °ªÀÓ(App -> OSD, Protocol)
	IFH_NOEXCUTE = 0x4,		// Ã³¸®ÇÏÁö ¾ÊÀ½
} IFER_CNBH;
...
/************************************************************************************************************/
/* EEPRom */
/* EEPRom µ¥ÀÌÅÍ Get, Set ÇÏ±â À§ÇÑ Index */
...
/* do not delete */
/* EEPRom µ¥ÀÌÅÍÀÇ ÀÎµ¦½º, ¼öÁ¤ÇÏÁö ¸»°Í */
#define IDX_NULL				0
...
#define VDX_GAIN_LIMIT                      4112	// 20131212 Ãß°¡
#define VDX_STB_ON                          4113	// 20131212 Ãß°¡
#define VDX_STB_HOLD                        4114	// 20131212 Ãß°¡
...
#define VDX_WD_BOCORR_LV					4134	// 20140320 Ãß°¡
...
/*4784 ~ 4786  is reserved - ³»ºÎº¯¼ö ÂüÁ¶ */
#define VDX_CAM_PAN					4784	//±¸Á¶Ã¼¿¡ ¾øÀ½,if_mw¿¡ Áö¿ªº¯¼ö·Î ÇÒ´çµÊ
#define VDX_CAM_TILT				4785	//±¸Á¶Ã¼¿¡ ¾øÀ½,if_mw¿¡ Áö¿ªº¯¼ö·Î ÇÒ´çµÊ
...
/* »ç¿ëÀÚ EEPRom µ¥ÀÌÅÍ Á¦°øÀ» À§ÇÑ ÀÎµ¦½º ½ÃÀÛ °ª */
#define IDX_USER                   5000

/************************************************************************************************************/
/* OSD */
/* OSD_KeyProc ¿¡¼­ »ç¿ëÇÏ´Â Key °ª */
...
typedef enum {
	...
	CH_145,         //Ë­ °­ÇÏ´Ù°­       //?  °­ÇÏ´Ù°­
	CH_146,         //?  °±´Ù»ó         //ßÁ °±´Ù»ó
	CH_147,         //?  °Å´À¸± Åë      //÷Ö °Å´À¸± Åë
	CH_148,         //?  °Å¿ï°æ	//Ìð °Å¿ï°æ
	CH_149,         //Ìí °æ°èÇÒ °æ      //Ìí °æ°èÇÒ °æ
	CH_150,         //?  °í¸£´ÙÁ¶       //ðà °í¸£´ÙÁ¶
	CH_151,         //?  °í¸®È¯         //ü» °í¸®È¯
	CH_152,         //?  °ü¹®°ü         //Î¼ °ü¹®°ü
	CH_153,         //?  ±¸¸£´ÙÀü       //ï® ±¸¸£´ÙÀü
	CH_154,         //?  ±¸¸¦°ï         //Íã ±¸¸¦°ï
	CH_155,         //?  ±ÂÇÏ´Ù»õ       //ßß ±ÂÇÏ´Ù»õ
	CH_156,         //?  ±×´ÃÀ½         //ëä ±×´ÃÀ½
	CH_157,         //?  ±×¸²µµ         //Óñ ±×¸²µµ
	CH_158,         //?  ±×¸²Á·ÀÚÁ¤     //ïÓ ±×¸²Á·ÀÚÁ¤
	CH_159,         //Ïõ ±â°è±â         //Ñ¦ ±â°è±â
	CH_160,         //?  ±é´Ùº¸         //ÜÍ ±é´Ùº¸
	CH_161,         //?  ±ï´Ù»ê         //ß¢ ±ï´Ù»ê
	CH_162,         //Þû ±ðÀ»»è         //Ï¡ ³ª´©´Ù±¸
	CH_163,         //?  ³ª´©´Ù±¸       //âÃ ³ª¸£´Ù¼ö
	CH_164,         //?  ³ª¸£´Ù¼ö       //úé ³ªÅ¸³ª´ÙÇö
	CH_165,         //?  ³ªÅ¸³ª´ÙÇö     //çå ³¯Ä«·Ó´Ù¿¹
	CH_166,         //?  ³¯Ä«·Ó´Ù¿¹     //éÐ ³Ë³ËÇÒ ¿ì
	CH_167,         //?  ³Ë³ËÇÒ ¿ì      //Î° ³Ð´Ù°ü
	CH_168,         //?  ³Ð´Ù°ü         //?  ³ìÀÌ´Ù»è
	CH_169,         //?  ³ìÀÌ´Ù»è       //üÜ ´©¸£´ÙÈ²
	CH_170,         //?  ´©¸£´ÙÈ²       //Óß ´ë´äÇÒ´ë
	CH_171,         //?  ´ë´äÇÒ´ë       //Êõ ´ú°¨
	CH_172,         //?  ´ëÂÊ°£         //êÌ µÑ·¹À§
	CH_173,         //?  ´ú°¨           //Ðä µî±Þ±Þ
	CH_174,         //?  µÑ·¹À§         //âË µû¸¦ ¼ö
	...
	CH_187,         //?  ¹®¹®           //çè ¹Ì¸®¿¹
	CH_188,         //?  ¹Ì¸®¿¹         //üµ ¹Ù²Ù´ÙÈ¯
	CH_189,         //?  ¹Ù²Ù´ÙÈ¯       //øé ¹èºÎ¸¦ Æ÷
	CH_190,         //?  ¹èºÎ¸¦ Æ÷      //ï³ ¹ø°³Àü
	CH_191,         //?  ¹ø°³Àü         //àì ¹øÂ½ÀÌ´Ù¼¶
	CH_192,         //?  ¹øÂ½ÀÌ´Ù¼¶     //Ûô ¹ý¹ü
	CH_193,         //Ûõ ¹ý¹ü           //àâ º£Ç®´Ù¼³
	CH_194,         //?  º£Ç®´Ù¼³       //Ü¨ º¯ÇÏ´Ùº¯
	CH_195,         //?  º¯ÇÏ´Ùº¯       //ûÜ ºÎ¸¦È£/ ÀÌ¸§È£
	CH_196,         //?  ºÎ¸¦È£/ ÀÌ¸§È£ //ûõ ºÓ´ÙÈ«
	CH_197,         //?  ºÓ´ÙÈ«         //Ëõ ºøÀå°Ç
	CH_198,         //?  ºøÀå°Ç         //Êà »çÀÌ°£
	CH_199,         //?  »çÀÌ°£         //â¦ ¼¼´Ù¼ö
	CH_200,         //?  ¼¼´Ù¼ö         //ëß ¼û±â´ÙÀº
	CH_201,         //?  ¼û±â´ÙÀº       //Ê­ ½Ã·· °¡
	CH_202,         //?  ½Å·É·É         //ÖÄ ½Å·É·É
	CH_203,         //?  ¾Æ¿ì¸¦ º´      //?  ¾Æ¿ì¸¦ º´
	CH_204,         //?  ¾È°³¹«         //Ùö ¾È°³¹«
	CH_205,         //?  ¾È³»           //Ò® ¾È³»
	CH_206,         //?  ¾È¿ÂÇÒ¿Â       //è± ¾È¿ÂÇÒ¿Â
	CH_207,         //?  ¾Ë¸± º¸        //ÜÃ ¾Ë¸± º¸
	CH_208,         //?  ¾ó±¼¾È         //?  ¾ó±¼¾È
	CH_209,         //?  ¾ó´Ùµ¿         //ÔÐ ¾ó´Ùµ¿
	CH_210,         //?  ¿­ °è          //?  ¿­ °è
	CH_211,         //?  ¿­´Ù°³         //ËÒ ¿­´Ù°³
	CH_212,         //?  ¿òÁ÷ÀÌ´Ùµ¿     //ÔÑ ¿òÁ÷ÀÌ´Ùµ¿
	CH_213,         //?  ÀÇ³íÇÒ ÀÇ      //ì¡ ÀÇ³íÇÒ ÀÇ
	CH_214,         //?  ÀÏÄÂ´ÙÄª       //öà ÀÏÄÂ´ÙÄª
	CH_215,         //?  ÀÚ¹°¼è¼â       //áð ÀÚ¹°¼è¼â
	CH_216,         //?  Àü±âÀü         //îî Àü±âÀü
	CH_217,         //?  Á¤Å½ÇÏ´ÙÁ¤     //ïÏ Á¤Å½ÇÏ´ÙÁ¤
	CH_218,         //?  Áö°Ô¹®È£       //ûÂ Áö°Ô¹®È£
	CH_219,         //?  ÁúºÎ           //Ý¶ ÁúºÎ
	CH_220,         //?  ÂÊ¶÷           //ÕÀ ÂÊ¶÷
	CH_221,         //÷× ÅëÇÏ´ÙÅë       //÷× ÅëÇÏ´ÙÅë
	CH_222,         //?  Çª¸£´Ù·Ï       //Öà Çª¸£´Ù·Ï
	CH_223,         //?  Çê°£Ã¢         //óß Çê°£Ã¢
	CH_224,         //?  Çì¾Æ¸®´ÙÃø     //ö´ Çì¾Æ¸®´ÙÃø
	CH_225,         //?  Çü»ó »ó        //ßÒ Çü»ó »ó
	CH_226,         //?  È¬´Ü           //Ó¤ È¬´Ü
	CH_227,         //?  È­ÇÕÇÒ Çù      //úð È­ÇÕÇÒ Çù
	CH_228,         //?  È¸º¹ÇÒ º¹      //ÜÖ È¸º¹ÇÒ º¹
	CH_229,         //?  Èí¼öÇÏ´Ù¼·     //àî Èí¼öÇÏ´Ù¼·
	CH_230,         //Ê­ ½Ã·· °¡//
	CH_231,         //? ¹®Å× ±¤//
	CH_MAX
} MULTILANGUAGE_CHA;

/* OSD Font¿¡ ´ëÇÑ ÀÎµ¦½º - !! Àý´ë ¼ø¼­°¡ ¹Ù²î¸é ¾ÈµÊ !! */
typedef enum _OSD_STR {
	OSD_STR_NULL,					    // "" ¾Æ¹«°Íµµ Ãâ·ÂÇÏÁö ¾ÊÀ½*/
	OSD_STR_0_5,                        // "0.5"
	OSD_STR_1_0,                        // "1.0"
	OSD_STR_1_5,                        // "1.5"
	OSD_STR_2_0,                        // "2.0"
	...
	OSD_STR_FINISH                    // OSD MapÀÇ ¸¶Áö¸·À» ÀÇ¹Ì
} OSD_STR;
...
typedef enum _REPLY_TYPE{
	...
	CNBA_REPLY_PRESET_END,		//g_CamData.FLD.PRESET_END : 1 ÀÌ¸é µ¿ÀÛ, PresetÀÌ ³¡³².
	CNBA_REPLY_MOTION_DETECT,	//MotionÀÌ Detecting µÊ.
	CNBA_REPLY_1SHOT_AF_END,	//g_CamData.FLD._1SHOT_END : 1 ÀÌ¸é µ¿ÀÛ, One Push Focus Á¾·á¸¦ ¾Ë¸²
	CNBA_REPLY_MENU_OFF,		//¸Þ´º°¡ ²¨Á³´Ù.
	CNBA_REPLY_REFRESH,			//????
	CNBA_REPLY_NON_ZTR_MOVE,	//Non Zoom TrackingÀÌ ¹«½Ã‰ç´Ù.
	CNBA_REPLY_LENS_INIT_END,	//·»Áî Refresh°¡ ÀÏ¾î³ª¸é È£ÃâÇÑ´Ù.
	VSC_REPLY_MAX,
} REPLY_TYPE;
/*************************************************************************************************************
* STRUCTURE
...
OSD_MAP *IF_OSDGet_pCurmap();								// ÇöÁ¦ OSD_MAPÀÇ Pointer¸¦ Ãâ·ÂÇÔ
...
MICLIB_IF_MW_EXT uint08 IF_PTC_GetTxQue(void);			//Uart_drv¿¡ µî·Ï
MICLIB_IF_MW_EXT uint08 IF_PTC_GetRxQue(void);			//¿ÜºÎ¿¡¼­ CNB_H¸¦ ¿î¿ë
MICLIB_IF_MW_EXT void IF_PTC_SetTxQue(uint08 txData);	//¿ÜºÎ¿¡¼­ CNB_H¸¦ ¿î¿ë
MICLIB_IF_MW_EXT void IF_PTC_SetRxQue(uint08 rxData);	//Uart_drv¿¡ µî·Ï
